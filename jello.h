...
extern int z_mouseDelta[2], z_mouseOrigin[2];
extern GLdouble z_mVMat[16], z_projMat[16];
extern bool z_hit;//curser doesnt hit obj
extern vec z_hitPos, z_userForce;
